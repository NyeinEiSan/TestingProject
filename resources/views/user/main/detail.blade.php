        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4"></h3>{{ $pizza->price }} kyats</h3>
                        ...
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square" href="{{ route('user#detail', $p->id) }}"><i
...
@section('scriptSource')
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: 'get',
                url: 'http://localhost/lara_auth/public/user/ajax/increaseView',
                data: {
                    ...
                    success: function(response) {
                        if (response.status == 'success') {
                            window.location.href =
                                "http://localhost/lara_auth/public/user/home";
                        }
                    }
                })
            })
